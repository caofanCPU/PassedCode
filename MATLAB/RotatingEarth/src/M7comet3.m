...
if size(co,1)>=3,
  ...
  head = line('parent',ax,'color',co(1,:),'marker','o', ...
    'MarkerFaceColor','k', 'MarkerSize',8, ...
              'xdata',x(1),'ydata',y(1),'zdata',z(1));
  body = line('parent',ax,'color',co(2,:),'linestyle','-', ...
              'xdata',[],'ydata',[],'zdata',[]);
  tail = line('parent',ax,'Color','r','LineWidth',3,'linestyle','-', ...
              'xdata',[],'ydata',[],'zdata',[]);
else
  % Choose first three colors for head, body, and tail
